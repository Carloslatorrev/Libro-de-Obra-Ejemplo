...
{
    public class InternetDocumentosServices : InternetServices
    {
        ...
        public static async Task<IEnumerable<MAE_TipoComunicacion>> GetTipoComunicacion(string id)
        {
            var json = "";
            try
            {
            ...
            var libro = JsonConvert.DeserializeObject<IEnumerable<MAE_TipoComunicacion>>(json);
            return libro;
